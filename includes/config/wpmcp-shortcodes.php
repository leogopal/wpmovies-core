<?php
/**
 * WPMoviesCore Config Shortcodes definition
 *
...
$wpmcp_shortcodes = array(
	...
	'movie_grid' => array(
		'atts' => array(
			...
			'order' => array(
				'default' => wpmcp_o( 'movie-archives-movies-order' ),
				'values'  => array( 'ASC', 'DESC' ),
				'filter'  => 'esc_attr'
			),
			'orderby' => array(
				'default' => wpmcp_o( 'movie-archives-movies-orderby' ),
				'values'  => array( 'title', 'date', 'localdate', 'rating' ),
				'filter'  => 'esc_attr'
			),
			'number' => array(
				'default' => wpmcp_o( 'movie-archives-movies-per-page' ),
				'values'  => null,
				'filter'  => 'intval'
			),
			'columns' => array(
				'default' => wpmcp_o( 'movie-archives-grid-columns' ),
				'values'  => null,
				'filter'  => 'intval'
			),
			'rows' => array(
				'default' => wpmcp_o( 'movie-archives-grid-rows' ),
				'values'  => null,
				'filter'  => 'intval'
			),
			'view' => array(
