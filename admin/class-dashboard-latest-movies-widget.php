...
if ( ! class_exists( 'WPMCP_Dashboard_Latest_Movies_Widget' ) ) :

	class WPMCP_Dashboard_Latest_Movies_Widget extends WPMCP_Dashboard {
		 ...
		 * @var      string
		 */
		protected $widget_id = 'wpmcp_dashboard_latest_movies_widget';
