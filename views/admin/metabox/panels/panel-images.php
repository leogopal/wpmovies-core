		...
		<div id="wpmcp-images" class="wpmcp-images">
...
<?php endforeach; ?>
					...
					<li class="tmdb_movie_images tmdb_movie_imported_image"><a href="#" id="tmdb_load_images"><?php _e( 'Load Images', 'wpmoviescore' ); ?></a></li>
