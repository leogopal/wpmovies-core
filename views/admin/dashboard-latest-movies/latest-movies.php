...
?>
								<em><?php _e( 'No movies found', 'wpmoviescore' ); ?></em>
								<p style="text-align:center"><a href="<?php echo admin_url( 'post-new.php?post_status=publish&post_type=movie' ) ?>"><span class="wpmolicon icon-plus"></span> <?php _e( 'Add a movie!', 'wpmoviescore' ) ?></a></p>
<?php
endif;
...
if ( ! defined( 'DOING_AJAX' ) || true !== DOING_AJAX ) : ?>
							<div style="text-align:center">
								<a href="#" id="latest_movies_load_more" class="button button-default hide-if-no-js<?php if ( '0' == $settings['show_more'] ) echo ' hide-if-js'; ?>">
									<span class="wpmolicon icon-plus"></span> <span><?php _e( 'Load more', 'wpmoviescore' ) ?></span>
								</a>
							</div>
<?php
endif;
