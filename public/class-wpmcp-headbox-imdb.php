...
if ( ! class_exists( 'WPMCP_Headbox_IMDb' ) ) :

	class WPMCP_Headbox_IMDb extends WPMCP_Headbox {
		...
		public function render( $content = null ) {
			...
			foreach ( $_meta as $m )
				$meta[ $m ] = apply_filters( "wpmcp_format_movie_$m", $meta[ $m ] );

			$details['rating_stars'] = apply_filters( 'wpmcp_movie_rating_stars', $details['rating'], $id, $base = 10 );

			$attributes = compact( 'id', 'meta', 'details', 'poster', 'images', 'theme' );

			$content = WPMoviesCore::render_template( 'movies/movie-imdb-headbox.php', $attributes, $require = 'always' );
