<?php
/**
 * WPMoviesCore Movie Search Class extension.
 * 
...
if ( ! class_exists( 'WPMCP_Search' ) ) :

	class WPMCP_Search extends WPMCP_Movies {
		...
		public static function by_spoken_languages( $language, $format = 'array' ) {
			...
			$value = WPMCP_L10n::get_language_native_name( $value );
		...
		private static function filter_value( $value ) {
			...
			if ( '1' == wpmcp_o( 'rewrite-enable' ) ) {
				...
				$value = WPMCP_L10n::translate_rewrite( $value );
			}
